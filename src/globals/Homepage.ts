    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          type: 'row',
          fields: [
            { name: 'eyebrowColor', label: 'Màu nhãn nhỏ', type: 'text', admin: { placeholder: '#0878d1', width: '25%' } },
            { name: 'titleColor', label: 'Màu tiêu đề', type: 'text', admin: { placeholder: '#143653', width: '25%' } },
            { name: 'descriptionColor', label: 'Màu mô tả', type: 'text', admin: { placeholder: '#647f94', width: '25%' } },
            { name: 'backgroundColor', label: 'Màu nền mục', type: 'text', admin: { placeholder: '#ffffff', width: '25%' } },
          ],
        },
        {
          type: 'row',
          fields: [
            { name: 'eyebrowSize', label: 'Cỡ nhãn nhỏ (px)', type: 'number', min: 8, max: 40, admin: { width: '33%' } },
            { name: 'titleSize', label: 'Cỡ tiêu đề (px)', type: 'number', min: 18, max: 72, admin: { width: '33%' } },
            { name: 'descriptionSize', label: 'Cỡ mô tả (px)', type: 'number', min: 10, max: 36, admin: { width: '33%' } },
          ],
        },
        {
          type: 'row',
