...
const menuLinkFields = (): Field[] => [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Góc cảnh báo y tế & Cộng đồng', value: '/goc-canh-bao' },
      { label: 'Lịch khám – Toàn bộ mục', value: '/lich-kham' },
      { label: 'Bảng giá dịch vụ – Toàn bộ mục', value: '/bang-gia' },
      { label: 'Chất lượng bệnh viện', value: '/chat-luong-benh-vien' },
      { label: 'Dành cho người bệnh (Cổng tổng hợp)', value: '/danh-cho-nguoi-benh' },
      { label: 'Quy trình khám bệnh', value: '/quy-trinh-kham-benh' },
      { label: 'Lịch khám bệnh & Giờ làm việc', value: '/lich-kham-benh' },
      { label: 'Lịch làm việc cơ quan (Lịch tuần)', value: '/lich-lam-viec' },
      { label: 'Khảo sát ý kiến người bệnh', value: '/khao-sat' },
      { label: 'Góp ý – Phản ánh', value: '/gop-y' },
      { label: 'Tra cứu phản ánh', value: '/gop-y/tra-cuu' },
      { label: 'Hỏi đáp y tế (FAQ)', value: '/hoi-dap' },
      { label: 'Biểu mẫu điện tử', value: '/bieu-mau' },
