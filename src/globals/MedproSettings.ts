...
export const MedproSettings: GlobalConfig = {
  slug: 'medpro-settings', label: 'Đặt khám Medpro', admin: { group: '🏥 Khám bệnh & Dịch vụ Y tế' }, access: { read: loggedIn, update: moduleAccess('appointments', 'edit') }, versions: { max: 20 },
  fields: [
