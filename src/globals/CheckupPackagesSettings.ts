...
export const CheckupPackagesSettings: GlobalConfig = {
  ...
  fields: [
    ...
    {
      name: 'contentBlock',
      label: 'Bài viết chi tiết & Hướng dẫn khám sức khỏe (RichText)',
      type: 'group',
      fields: [
        { name: 'enabled', label: 'Bật hiển thị khối bài viết này', type: 'checkbox', defaultValue: true },
        { name: 'title', label: 'Tiêu đề bài viết', type: 'text', defaultValue: 'Chính sách Khám Sức khỏe Định kỳ & Tư vấn Doanh nghiệp / Cá nhân' },
        { name: 'subtitle', label: 'Mô tả ngắn gọn / Phụ đề bài viết', type: 'textarea', defaultValue: 'Quy trình tiếp nhận, đăng ký khám theo đoàn thể, công ty, trường học và cá nhân với quy chuẩn xét nghiệm chẩn đoán hiện đại tại Bệnh viện Đa khoa Khu vực Thới Lai.' },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'kicker', label: 'Nhãn nhỏ phía trên (Kicker)', type: 'text', admin: { placeholder: 'VÍ DỤ: ƯU ĐÃI ĐOÀN THỂ HOẶC CHUYÊN ĐỀ' } },
