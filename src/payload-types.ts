...
export interface Media {
  ...
  caption?: string | null;
  /**
   * Tất cả nhóm hiện chỉ lưu đúng một file gốc. Với ảnh có chữ nên tải ảnh chuẩn 16:9 để hiển thị đẹp trên trang chủ.
   */
  group?:
    | (
        | 'news'
...
export interface News {
  ...
  slug: string;
  /**
   * Chọn chuyên mục quản lý tập trung theo cấu trúc tin tức bệnh viện.
   */
  categoryRef?: (number | null) | Category;
  /**
   * Bảo toàn dữ liệu cũ. Bài viết mới chỉ cần chọn ô “Chuyên mục chuẩn”.
   */
  category?: string | null;
  /**
   * Tối đa 500 ký tự. Phần tóm tắt giúp độc giả nắm nhanh nội dung trước khi đọc chi tiết.
   */
  excerpt?: string | null;
  /**
   * 💡 Khuyên dùng ảnh nằm ngang tỷ lệ 16:9 (khoảng 1200×675px hoặc 800×450px). Khi bỏ trống, website sẽ tự dùng ảnh mặc định của bệnh viện.
   */
  cover?: (number | null) | Media;
  /**
   * Trình soạn thảo hỗ trợ định dạng tiêu đề, hình ảnh minh họa, căn lề, bảng dữ liệu, danh sách và liên kết.
   */
  content: {
    root: {
      type: string;
  ...
  /**
   * Nguồn bài viết / Tác giả biên soạn. Để trống sẽ dùng mặc định theo mẫu trang.
   */
  source?: string | null;
  /**
  ...
  seoTitle?: string | null;
  /**
   * Để trống để dùng URL tự động. Chỉ nhập khi cần trỏ về nguồn bài gốc khác.
   */
  canonicalUrl?: string | null;
  /**
  ...
  seoDescription?: string | null;
  /**
   * Ảnh khi chia sẻ link lên Zalo, Facebook. Khuyên dùng tỷ lệ 1200×630px. Để trống sẽ tự động lấy Ảnh đại diện.
   */
  seoImage?: (number | null) | Media;
  /**
   * Bật nếu không muốn Google lập chỉ mục bài viết này.
   */
  noIndex?: boolean | null;
  /**
   * Bật nếu muốn ẩn bài viết khỏi sơ đồ sitemap.xml.
   */
  excludeFromSitemap?: boolean | null;
  /**
   * Bật để ưu tiên hiển thị ở các vị trí tin tức tiêu điểm nổi bật trên trang chủ.
   */
  featured?: boolean | null;
  /**
   * Ghim bài viết lên vị trí đầu tiên của danh sách tin tức.
   */
  pinned?: boolean | null;
  /**
...
export interface Notice {
  ...
  slug: string;
  /**
   * Chọn chuyên mục quản lý thông báo.
   */
  categoryRef?: (number | null) | Category;
  /**
   * Phân loại mức độ khẩn cấp để gắn thẻ màu tương ứng.
   */
  ...
  cover?: (number | null) | Media;
  /**
   * Trình soạn thảo hỗ trợ định dạng tiêu đề, danh sách, bảng dữ liệu và liên kết.
   */
  content: {
    root: {
      type: string;
  ...
  attachments?:
    ...
    | null;
  /**
   * Chọn mẫu giao diện trang chi tiết cho thông báo này.
   */
  layoutTemplate?: ('default' | 'bachmai' | 'classic') | null;
  /**
   * Nguồn hoặc đơn vị phát hành thông báo.
   */
  source?: string | null;
  /**
   * Tùy chọn cách hiển thị để ảnh không bị cắt mất chữ hoặc chi tiết quan trọng: Chọn "Vừa vặn khung" để ảnh luôn hiển thị trọn vẹn 100% không bị cắt; hoặc chọn "Lấp đầy khung" để phủ kín toàn bộ thẻ.
  ...
  coverPosition?: ('top' | 'center' | 'bottom') | null;
  /**
   * Để trống sẽ tự động lấy Tiêu đề thông báo.
   */
  seoTitle?: string | null;
  /**
  ...
  canonicalUrl?: string | null;
  /**
   * Để trống sẽ tự động lấy từ ô Mô tả ngắn.
   */
  seoDescription?: string | null;
  /**
   * Ảnh khi chia sẻ link lên Zalo, Facebook. Khuyên dùng tỷ lệ 1200×630px. Để trống sẽ tự động lấy Ảnh đại diện.
  ...
  seoImage?: (number | null) | Media;
  /**
   * Bật nếu không muốn Google lập chỉ mục thông báo này.
   */
  noIndex?: boolean | null;
  /**
  ...
  publishedAt?: string | null;
  /**
   * Tùy chọn hẹn giờ bắt đầu hiển thị.
   */
  startAt?: string | null;
  /**
...
export interface Procurement {
  ...
  excerpt?: string | null;
  /**
   * Không bắt buộc; khi để trống dùng ảnh mặc định của Đấu thầu – Mua sắm.
   */
  cover?: (number | null) | Media;
  /**
   * Hồ sơ mời thầu, yêu cầu kỹ thuật, điều kiện tham gia và các nội dung chi tiết.
   */
  content: {
    root: {
      type: string;
  ...
  changeLog?:
    ...
    | null;
  /**
   * Chọn mẫu giao diện trang chi tiết cho gói thầu này.
   */
  layoutTemplate?: ('default' | 'bachmai' | 'classic') | null;
  source?: string | null;
  /**
  ...
  coverPosition?: ('top' | 'center' | 'bottom') | null;
  /**
   * Để trống sẽ tự động lấy Tiêu đề gói thầu.
   */
  seoTitle?: string | null;
  /**
   * Để trống để dùng URL tự động.
  ...
  seoImage?: (number | null) | Media;
  /**
   * Bật nếu không muốn Google lập chỉ mục gói thầu này.
   */
  noIndex?: boolean | null;
  /**
   * Bật nếu muốn ẩn khỏi sitemap.xml.
  ...
  excludeFromSitemap?: boolean | null;
  /**
   * Ngày và giờ phát hành thông tin.
   */
  publishedAt?: string | null;
  /**
   * Thời hạn cuối cùng nộp hồ sơ / báo giá.
   */
...
export interface Document {
  ...
  number?: string | null;
  /**
   * Chọn chuyên mục quản lý văn bản chuẩn.
   */
  categoryRef?: (number | null) | Category;
  year?: number | null;
  issuer?: string | null;
  ...
  summary?: string | null;
  /**
   * Tải tệp mới hoặc chọn lại tệp đã có trong Thư viện. Hệ thống tự động mở trình đọc PDF trực tuyến.
   */
  file: number | Media;
  /**
   * Không bắt buộc. Nếu bỏ trống website dùng ảnh mặc định Văn bản – Tài liệu trong Hệ thống → Ảnh mặc định nội dung.
   */
  cover?: (number | null) | Media;
  /**
   * Tùy chọn: Nhập nội dung toàn văn của văn bản trực tiếp bằng trình soạn thảo.
   */
  content?: {
    root: {
      type: string;
  ...
  /**
   * Để trống sẽ tự động lấy Tên văn bản.
   */
  seoTitle?: string | null;
  /**
   * Để trống để dùng URL tự động.
  ...
  canonicalUrl?: string | null;
  /**
   * Để trống sẽ tự động lấy từ ô Trích yếu.
   */
  seoDescription?: string | null;
  /**
   * Ảnh khi chia sẻ link lên Zalo, Facebook. Khuyên dùng tỷ lệ 1200×630px. Để trống sẽ tự động lấy Ảnh đại diện.
  ...
  seoImage?: (number | null) | Media;
  /**
   * Bật nếu không muốn Google lập chỉ mục văn bản này.
   */
  noIndex?: boolean | null;
  /**
   * Bật nếu muốn ẩn khỏi sitemap.xml.
...
export interface Specialty {
   ...
   */
  coverFitHome?: ('cover-top' | 'contain' | 'cover-center' | 'cover-bottom' | 'cover' | 'fill') | null;
  /**
   * Tùy chọn hiển thị riêng biệt cho Khung ảnh lớn trên trang chi tiết chuyên khoa.
   */
  coverFitDetail?: ('contain' | 'cover-top' | 'cover-center' | 'cover-bottom' | 'cover' | 'fill') | null;
  /**
   * Chỉnh góc lấy nét khi ảnh bị xén mất phần đầu hoặc khuôn mặt.
   */
  coverPosition?: ('top' | 'center' | 'bottom') | null;
  services?: {
    root: {
  ...
  showDepartmentCard?: boolean | null;
  showBookingCard?: boolean | null;
  customBookingTitle?: string | null;
  customBookingButtonLabel?: string | null;
  customBookingButtonUrl?: string | null;
  customHotline?: string | null;
  customBookingDesc?: string | null;
  showNoticeBox?: boolean | null;
  customNoticeText?: string | null;
  /**
   * Bấm "Thêm Banner" để tải lên hoặc chọn ảnh từ thư viện, nhập tiêu đề và liên kết tùy ý mà không cần dùng mã JSON.
   */
  sidebarBanners?:
    | {
        /**
         * Tải ảnh mới hoặc chọn ảnh từ thư viện media của bệnh viện.
         */
    ...
    | null;
  /**
   * 💡 (Dành cho nâng cao) Nếu đã dùng danh sách chọn ảnh ở trên thì có thể để trống ô này.
   */
  sidebarBannersJson?: string | null;
  showCoverImage?: boolean | null;
  showSummaryLead?: boolean | null;
  showContentSection?: boolean | null;
  showServicesSection?: boolean | null;
  showDoctorsSection?: boolean | null;
  showProtocolsSection?: boolean | null;
...
export interface Recruitment {
  ...
  categoryRef?: (number | null) | Category;
  /**
   * Khoa/phòng có nhu cầu tiếp nhận nhân sự.
   */
  department?: (number | null) | Department;
  quantity?: number | null;
  excerpt?: string | null;
  /**
   * 💡 Khuyên dùng ảnh nằm ngang tỷ lệ 16:9 (khoảng 1200×675px hoặc 800×450px). Khi bỏ trống, website sẽ tự dùng ảnh mặc định của Tuyển dụng.
   */
  cover?: (number | null) | Media;
  /**
   * Mô tả công việc, tiêu chuẩn ứng viên, quyền lợi chế độ và hồ sơ yêu cầu.
   */
  content: {
    root: {
      type: string;
  ...
  attachments?:
    ...
    | null;
  /**
   * Giữ để các tin tuyển dụng cũ không mất tệp. Bài mới dùng danh sách Tệp đính kèm bên trên.
   */
  attachment?: (number | null) | Media;
  /**
   * Chọn mẫu giao diện trang chi tiết cho tin tuyển dụng này.
   */
  layoutTemplate?: ('default' | 'bachmai' | 'classic') | null;
  source?: string | null;
  /**
  ...
  coverFit?: ('contain' | 'cover-top' | 'cover-center' | 'cover-bottom' | 'cover' | 'fill') | null;
  /**
   * Để trống sẽ tự động lấy Tiêu đề tuyển dụng.
   */
  seoTitle?: string | null;
  /**
   * Để trống để dùng URL tự động.
  ...
  seoImage?: (number | null) | Media;
  /**
   * Bật nếu không muốn Google lập chỉ mục tin này.
   */
  noIndex?: boolean | null;
  /**
   * Bật nếu muốn ẩn khỏi sitemap.xml.
  ...
  excludeFromSitemap?: boolean | null;
  /**
   * Ngày và giờ đăng tin tuyển dụng.
   */
  publishedAt?: string | null;
  /**
   * Thời hạn cuối cùng tiếp nhận hồ sơ ứng tuyển.
   */
  deadlineAt?: string | null;
  /**
   * Luồng nội dung: Nháp → Gửi duyệt → Duyệt → Xuất bản/Ẩn. Quyền chuyển trạng thái được kiểm tra phía server.
...
export interface CustomPost {
  ...
  slug: string;
  /**
   * Chọn mục nội dung mở rộng (VD: Chuyển đổi số, Kế hoạch công tác...).
   */
  section: number | ContentSection;
  excerpt?: string | null;
  /**
   * Không bắt buộc; khi để trống dùng ảnh mặc định của mục nội dung.
   */
  cover?: (number | null) | Media;
  /**
   * Trình soạn thảo hỗ trợ văn bản, hình ảnh minh họa, bảng và liên kết.
   */
  content: {
    root: {
      type: string;
  ...
  excludeFromSitemap?: boolean | null;
  /**
   * Ghim bài viết lên vị trí đầu danh sách.
   */
  pinned?: boolean | null;
  /**
   * Ngày và giờ đăng bài viết.
   */
  publishedAt?: string | null;
  /**
   * Luồng nội dung: Nháp → Gửi duyệt → Duyệt → Xuất bản/Ẩn. Quyền chuyển trạng thái được kiểm tra phía server.
...
export interface AdvancedTechnique {
  ...
  /**
   * Chỉ áp dụng khi bật liên kết ở trên. Nếu để trống, hệ thống sẽ tự động dẫn đến trang chi tiết kỹ thuật (/ky-thuat-chuyen-sau/[slug]).
   */
...
export interface OurExpert {
  ...
  enableLink?: boolean | null;
  /**
   * Chỉ có tác dụng khi bật liên kết ở trên. Nếu để trống, hệ thống sẽ tự động dẫn đến trang chi tiết của bác sĩ (/bac-si/[slug]).
   */
  url?: string | null;
  openNewTab?: boolean | null;
  /**
...
export interface SpecialtiesSelect<T extends boolean = true> {
  ...
  coverPosition?: T;
  services?: T;
  showDepartmentCard?: T;
  showBookingCard?: T;
  customBookingTitle?: T;
  customBookingButtonLabel?: T;
  customBookingButtonUrl?: T;
  customHotline?: T;
  customBookingDesc?: T;
  showNoticeBox?: T;
  customNoticeText?: T;
  ...
  sidebarBannersJson?: T;
  showCoverImage?: T;
  showSummaryLead?: T;
  showContentSection?: T;
  showServicesSection?: T;
  showDoctorsSection?: T;
  showProtocolsSection?: T;
...
export interface SiteSetting {
  ...
  /**
   * Logo được chọn ở trường Logo bệnh viện phía trên. Tại đây chỉnh hiển thị, kích thước, màu chữ, căn lề, bảng màu, font chữ, hiệu ứng nổi bật và ảnh/màu nền của vùng nhận diện.
   */
  headerBrandAppearance?: {
    ...
    /**
     * Font chữ riêng cho dòng tên bệnh viện. "Theo website" = dùng font hệ thống chung.
     */
    nameFontFamily?:
      | (
          | 'inherit'
      ...
      | null;
    nameFontWeight?: ('400' | '600' | '700' | '800' | '900') | null;
    /**
     * Chọn hiệu ứng để tên bệnh viện nổi bật hơn trên Header.
     */
    nameTextEffect?:
      ('none' | 'gradient-text' | 'shadow' | 'border-accent' | 'underline-accent' | 'highlight-bg') | null;
    /**
    ...
    sloganFontWeight?: ('400' | '500' | '600' | '700' | '800') | null;
    /**
     * Bật để slogan hiển thị nghiêng – phong cách khẩu hiệu truyền thống.
     */
    sloganItalic?: boolean | null;
    /**
     * Chọn hiệu ứng để câu slogan nổi bật hơn.
     */
    sloganTextEffect?: ('none' | 'gradient-text' | 'shadow' | 'decorative-underline' | 'star-wrap') | null;
  ...
  /**
   * Trường cũ, đã chuyển sang headerBrandAppearance. Ẩn để tránh nhầm lẫn.
   */
  brand?: {
    primaryColor?: string | null;
...
/**
 * Quản lý thông tin liên hệ, hotline, cấp cứu, địa chỉ, bản đồ Google Maps và giao diện trang /lien-he.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface ThemeSetting {
  ...
  /**
   * Cấu hình đồng bộ màu nền, màu chữ, cỡ chữ và khoảng cách cho Banner đầu trang của tất cả các trang: Bác sĩ, Tin tức, Thông báo, Đấu thầu, Bảng giá, Văn bản, Chuyên khoa, Lịch khám, v.v.
   */
  pageHero?: {
    bgType?: ('gradient' | 'solid') | null;
    /**
     * Mặc định chuẩn y tế nhỏ gọn: 22px
     */
    paddingVertical?: number | null;
    bgGradientStart?: string | null;
    bgGradientMiddle?: string | null;
  ...
  /**
   * Cấu hình đồng bộ màu nền, màu chữ, cỡ chữ và khoảng đệm cho toàn bộ các Section nội dung: Kỹ thuật chuyên sâu, Đội ngũ chuyên gia, Chuyên khoa, Tin tức nổi bật, Thông báo, Đấu thầu, Lịch khám, v.v.
   */
  sectionGlobal?: {
    bgColor?: string | null;
    borderRadius?: number | null;
    ...
    | {
        ...
        techniqueItems?:
          | {
              ...
              badge?: string | null;
              /**
               * 💡 Gợi ý kích thước chuẩn: Tỷ lệ đứng 1:1.15 hoặc 3:4 (ví dụ: 600×700px, 600×800px hoặc 500×580px). Tải poster hoặc ảnh kỹ thuật y tế chất lượng cao. Nếu để trống hệ thống sẽ tự lấy từ kỹ thuật liên kết.
               */
              image?: (number | null) | Media;
              /**
               * Tùy chọn cách hiển thị để poster/ảnh không bị cắt mất chữ hoặc góc: Chọn "Vừa vặn khung" để ảnh luôn hiển thị trọn vẹn 100% không bị cắt bất kỳ góc nào; hoặc chọn "Lấp đầy khung" nếu muốn ảnh phủ kín toàn bộ thẻ.
              ...
              imageFit?: ('contain' | 'cover-top' | 'cover-center' | 'cover-bottom' | 'fill') | null;
              /**
               * BẬT: Bấm vào thẻ kỹ thuật sẽ chuyển đến trang chi tiết kỹ thuật hoặc liên kết tùy chỉnh bên dưới. TẮT: Thẻ chỉ hiển thị thông tin để xem (không bấm chuyển trang, không hiện con trỏ link).
               */
              enableLink?: boolean | null;
              /**
        ...
        expertItems?:
          | {
              ...
              customSubtitle?: string | null;
              /**
               * 💡 Gợi ý kích thước chuẩn: Tỷ lệ đứng 3:4 hoặc 1:1.15 (ví dụ: 600×800px, 450×600px hoặc 400×460px). Tải ảnh chân dung áo blouse trắng nền sáng. Nếu để trống hệ thống sẽ tự dùng ảnh hồ sơ Bác sĩ.
               */
              image?: (number | null) | Media;
              /**
               * Tùy chọn cách hiển thị để ảnh chân dung không bị mất đầu hoặc viền xấu: Chọn "Vừa vặn khung" để ảnh luôn hiển thị trọn vẹn 100% không bị cắt bất kỳ góc nào; hoặc chọn "Lấp đầy khung - Canh đỉnh đầu" để ảnh phủ kín thẻ nhưng luôn thấy rõ khuôn mặt.
        ...
        featuredSources?:
          | {
              ...
              /**
               * Quy định lấy tối đa bao nhiêu bài mới nhất từ nguồn/chuyên mục này đưa lên Điểm tin (đặt 0 nếu tạm ẩn).
               */
              limit?: number | null;
              /**
...
export interface SystemSetting {
  ...
  /**
   * Bật / tắt ẩn hiện các mục thống kê để tránh trùng lặp hoặc ẩn các mục chưa dùng đến.
   */
  dashboardSettings?: {
    showNews?: boolean | null;
    showNotices?: boolean | null;
    showProcurement?: boolean | null;
    showDocuments?: boolean | null;
    showRecruitment?: boolean | null;
    showSchedules?: boolean | null;
    showVaccines?: boolean | null;
    showFeedback?: boolean | null;
    showSurveys?: boolean | null;
    /**
     * Khi bật, các mục nội dung mới tạo thêm sẽ tự động xuất hiện thành thẻ thống kê riêng.
     */
    showDynamicSections?: boolean | null;
    showAreaChart?: boolean | null;
