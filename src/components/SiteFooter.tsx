...
export async function SiteFooter() {
  ...
  return <>
    ...
    {footer?.showMobileBar !== false && <div className="mobileActionBar">
      <a href="/">⌂<span>Trang chủ</span></a><a href="/lich-kham">▦<span>Lịch khám</span></a><a className="mobileBooking" href={medpro}>＋<span>Đặt khám</span></a><a className="mobileEmergency" href={`tel:${hotline}`}>☎<span>Cấp cứu</span></a>
    </div>}
  </>
}
