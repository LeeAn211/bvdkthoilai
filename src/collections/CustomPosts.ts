...
export const CustomPosts: CollectionConfig = {
  ...
  access: {
    read: publicPublishedFor('custom-posts'),
    create: moduleAccess('custom-posts', 'create'),
    update: workflowUpdateAccess('custom-posts'),
    delete: contentDeleteAccess('custom-posts'),
  },
  trash: true,
