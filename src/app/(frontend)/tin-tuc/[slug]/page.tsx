...
export default async function Page({ params }: Props) {
  ...
  // Kiểm tra cấu hình trong Admin: ArticleDetailSettings.applyNews hoặc ThemeSettings.detailLayout.applyNews (mặc định bật)
  const isBạchMaiLayout = (articleDetailSettings?.applyNews ?? theme?.detailLayout?.applyNews) !== false
